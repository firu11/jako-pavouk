...
function copyEmail() {
    navigator.clipboard.writeText('firu@jakopavouk.cz').then(
        function () {
            copy.value.style.transform = 'rotate(-25deg)';
            setTimeout(() => {
                copy.value.style.transform = 'rotate(15deg)';
                setTimeout(() => {
                    copy.value.style.transform = 'rotate(0deg)';
                }, 110);
            }, 110);
        },
        function (err) {
...
<template>
    ...
    <p>
        ...
        <!-- trochu menší mezera než 2x <br> -->
        Když jsem se rozhodl, že bych se chtěl naučit psát rychleji, začal jsem hledat vhodné programy, které by mi s tím pomohly.
        <br />
        Zjistil jsem ale, že zejména pro českou klávesnici jich není mnoho a některé z nich dokonce stojí téměř 1000 Kč. A tak jsem se rozhodl vytvořit si vlastní.
        <span style="margin: -14px" />
        <!-- trochu menší mezera než 2x <br> -->
        A ano, čteš správně! Text je psán v první osobě. Možná by se tato stránka měla jmenovat spíše "O mně", jelikož tento web spravuje pouze jeden člověk.
    </p>
    <p>
        Chtěl bych poděkovat těmto webům, které mi poskytly svůj obsah, ať už ve formě vzdělávacích textů, článků, nebo pohádek. Většina textů je upravena.
    ...
    <p>
        Jelikož je Jako Pavouk kompletně zdarma, je tu možnost tento projekt podpořit přes platformu Ko-fi níže. Moc si vážím vaší podpory!
