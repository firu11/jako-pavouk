...
<template>
    ...
    <Psani v-if="!konec" @konec="konecTextu" @restart="restart" @prodlouzit="prodlouzit" :text :klavesnice :hide-klavesnice="false" :nacitamNovej :cas="getCas(typTextu)" :delkaTextu />

    <Vysledek v-else @restart="restart" :preklepy :opravenych="opravenePocet" :delkaTextu="delkaNapsanehoTextu" :cas="getCas(typTextu)" :cislo :posledni :pismena :nejcastejsiChyby />
</template>
