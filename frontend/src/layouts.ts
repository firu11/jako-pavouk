...
export const specialniZnakyWindowsQWERTZ = new Map<string, string[]>(
    Object.entries({
        Ů: ['°;', 'U'],
        '@': ['Ctrl', 'Alt', 'V'],
        '[': ['Ctrl', 'Alt', 'F'],
...
export const specialniZnakyWindowsQWERTY = new Map<string, string[]>(
    Object.entries({
        Ů: ['°;', 'U'],
        '@': ['Ctrl', 'Alt', '2ě'],
        '[': ['Ctrl', 'Alt', '/ú'],
...
export const specialniZnakyMacOS = new Map<string, string[]>(
    Object.entries({
        Ů: ['⌥', '%=', 'U'],
        '@': ['⌥', '2ě'],
        '#': ['⌥', '3š'],
...
export const specialniZnakyLinuxQWERTZ = new Map<string, string[]>(
    Object.entries({
        Ů: ['°;', 'U'],
        '@': ['AltGr', 'V'],
        '[': ['AltGr', 'F'],
...
export const specialniZnakyLinuxQWERTY = new Map<string, string[]>(
    Object.entries({
        Ů: ['°;', 'U'],
        '@': ['AltGr', '2ě'],
        '[': ['AltGr', '/ú'],
