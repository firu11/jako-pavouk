...
import {
    ...
    schemaWindows,
    specialniZnakyMacOS,
    specialniZnakyWindowsQWERTZ,
    specialniZnakyWindowsQWERTY,
    schemaLinux,
    prstokladLinux,
    barvy,
...
<template>
    <div :class="{ hide: fullHide }" id="wraper">
        <div id="klavesnice" :class="{ rozmazany: props.rozmazat, 'rozmazany-min': props.cekame && !props.rozmazat }">
            <div :class="{}" class="radek" v-for="(radek, i) in schema" :key="i">
                ...
                >
                    ...
                    <div v-else-if="tlacitko == 'enter-noha' || barva(tlacitko) === ''" />
        ...
        <div id="nohy" :class="{ rozmazany: props.rozmazat }">
            <div class="kolecko" style="left: 101.5px; top: 7px" :style="{ backgroundColor: barvy.get('L_Mali') }" :class="{ koleckoAktivni: oznacenyPrst == 'L_Mali' }" />
            <div class="kolecko" style="left: 140.5px; top: -2px" :style="{ backgroundColor: barvy.get('L_Prs') }" :class="{ koleckoAktivni: oznacenyPrst == 'L_Prs' }" />
            <div class="kolecko" style="left: 182.5px; top: -9px" :style="{ backgroundColor: barvy.get('L_Pros') }" :class="{ koleckoAktivni: oznacenyPrst == 'L_Pros' }" />
            <div class="kolecko" style="left: 227px; top: -12px" :style="{ backgroundColor: barvy.get('L_Ukaz') }" :class="{ koleckoAktivni: oznacenyPrst == 'L_Ukaz' }" />
            <div class="kolecko" style="right: 149px; top: 7px" :style="{ backgroundColor: barvy.get('P_Mali') }" :class="{ koleckoAktivni: oznacenyPrst == 'P_Mali' }" />
            <div class="kolecko" style="right: 188px; top: -2px" :style="{ backgroundColor: barvy.get('P_Prs') }" :class="{ koleckoAktivni: oznacenyPrst == 'P_Prs' }" />
            <div class="kolecko" style="right: 229.5px; top: -9px" :style="{ backgroundColor: barvy.get('P_Pros') }" :class="{ koleckoAktivni: oznacenyPrst == 'P_Pros' }" />
            <div class="kolecko" style="right: 272px; top: -12px" :style="{ backgroundColor: barvy.get('P_Ukaz') }" :class="{ koleckoAktivni: oznacenyPrst == 'P_Ukaz' }" />
